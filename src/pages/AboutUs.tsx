...
const AboutUs = () => {
  ...
  return (
    <>
      <Helmet>
        <title>About EliteWins - Your Trusted Casino Review Experts</title>
        <meta name="description" content="Learn about EliteWins' mission to provide honest casino reviews, expert analysis, and player protection. Meet our team of gaming industry professionals." />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg text-gray-300 mb-6 leading-relaxed">
                  At EliteWins, we believe every player deserves a safe, fair, and enjoyable gaming experience. Our mission is to bridge the gap between players and reputable online casinos through transparent reviews, expert analysis, and unwavering commitment to player protection.
                </p>
